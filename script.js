...
<head>
    ...
    <title>Letter Drafting Game</title>
    <style>
        .hidden { display: none; }
        .letter-button { margin: 5px; }
        .vowel { color: red; }
    </style>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function prepareGroups() {
                ...
                console.log("Prepared groups:", groups); // Log to check group preparation
            }
            ...
            function showNextGroup() {
                if (currentGroupIndex < groups.length) {
                    ...
                    console.log("Showing group:", group); // Log to check displayed group
                } else {
